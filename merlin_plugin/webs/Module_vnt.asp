...
<body onload="initial();">
    ...
    <div id="vnt_loading_tip"
        style="display:none;position:fixed;top:0;left:0;width:100%;height:100%;z-index:9999;background:rgba(0,0,0,0.45);text-align:center;">
        <div
            style="margin-top:20%;display:inline-block;background:#2B373B;border-radius:10px;padding:30px 50px;box-shadow:3px 3px 15px #000;color:#99FF00;font-size:16px;font-weight:bold;">
            ⏳ 正在读取配置，请稍候...
        </div>
    </div>
                                ...
                                <table width="760px" border="0" cellpadding="5" cellspacing="0" bordercolor="#6b8fa3"
                                    ...
                                    <tr>
                                        <td bgcolor="#4D595D" colspan="3" valign="top">
                                            ...
                                            <div class="formfontdesc">VNT 是一个简便高效的异地组网、内网穿透工具。【仓库链接：<a
                                                    href="https://github.com/vnt-dev/vnt"
                                                    target="_blank"><em><u>Github</u></em></a>】【使用文档：<a
                                                    href="https://rustvnt.com"
                                                    target="_blank"><em><u>官网</u></em></a>&nbsp;&nbsp;<a
                                                    href="https://github.com/vnt-dev/vnt/blob/main/vnt-cli/README.md"
                                                    target="_blank"><em><u>客户端</u></em></a>&nbsp;&nbsp;<a
                                                    href="https://github.com/vnt-dev/vnts?tab=readme-ov-file#vnts"
                                                    target="_blank"><em><u>服务端</u></em></a>】【安卓端GUI：<a
                                                    href="https://github.com/vnt-dev/VntApp"
                                                    target="_blank"><em><u>VntApp</u></em></a>】【QQ群：<a
                                                    href="http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=o3Rr9xUWwAAnV9TkU_Nyj3yHNLs9k5F5&authKey=l1FKvqk7%2F256SK%2FHrw0PUhs%2Bar%2BtKYx0pLb7aiwBN9%2BKBCY8sOzWWEqtl4pdXAT7&noverify=0&group_code=1034868233"
                                                    target="_blank"><em><u>vnt组网交流群</u></em></a>】<br /><i>
                                                    点击下方参数设置的文字，可查看帮助信息 </i></div>
                                            <div id="tablet_show">
                                                    ...
                                                    <tr width="235px">
                                                        <td colspan="4" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <input id="show_btn1" class="show-btn1"
                                                                style="cursor:pointer" type="button" value="客户端" />
                                                            <input id="show_btn2" class="show-btn2"
                                                                style="cursor:pointer" type="button" value="服务端" />
                                                            <input id="show_btn3" class="show-btn3"
                                                                style="cursor:pointer" type="button" value="上传程序" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div id="simple_table">
                                                <table width="100%" border="1" align="center" cellpadding="4"
                                                    ...
                                                    style="box-shadow: 3px 3px 10px #000;margin-top: 0px;">
                                                    <thead>
                                                        <tr>
                                                            <td colspan="2"><a class="hintstyle"
                                                                    href="javascript:void(0);"
                                                                    onclick="openssHint(23)">vnt-cli 客户端设置</a></td>
                                                        </tr>
                                                    </thead>
                                                    <tr id="vnt-cli">
                                                        <th>
                                                            <label><a class="hintstyle" href="javascript:void(0);"
                                                                    onclick="openssHint(0)">开启客户端</a></label>
                                                        </th>
                                                        <td colspan="2">
                                                            <div class="switch_field"
                                                                style="display:table-cell;float: left;">
                                                                <label for="vnt_enable">
                                                                    <input id="vnt_enable" class="switch"
                                                            ...
                                                            <div>
                                                                <button id="vnt_action_btn"
                                                                    class="vnt_custom_btn"></button>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr id="vnt_status">
                                                    ...
                                                    <tr>
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(17)">定时功能(<i>0为关闭</i>)</a></th>
                                                        <td>
                                                            每 <input type="text"
                                                                oninput="this.value=this.value.replace(/[^\d]/g, '')"
                                                                id="vnt_cron_time" name="vnt_cron_time"
                                                                class="input_3_table" maxlength="2" value="0"
                                                                placeholder="" />
                                                            <select id="vnt_cron_hour_min" name="vnt_cron_hour_min"
                                                                style="width:60px;margin:3px 2px 0px 2px;"
                                                                class="input_option">
                                                                <option value="min">分钟</option>
                                                                <option value="hour">小时</option>
                                                            </select>
                                                            <select id="vnt_cron_type" name="vnt_cron_type"
                                                                style="width:60px;margin:3px 2px 0px 2px;"
                                                                class="input_option">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a type="button" class="info_btn" style="cursor:pointer"
                                                                href="javascript:void(0);"
                                                                onclick="open_conf('vnt_info');">当前设备信息</a>&nbsp;
                                                            <a type="button" class="info_btn" style="cursor:pointer"
                                                                href="javascript:void(0);"
                                                                onclick="open_conf('vnt_all');">所有设备信息</a>&nbsp;
                                                            <a type="button" class="info_btn" style="cursor:pointer"
                                                                href="javascript:void(0);"
                                                                onclick="open_conf('vnt_list');">所有设备列表</a><br><br>
                                                            <a type="button" class="info_btn" style="cursor:pointer"
                                                                href="javascript:void(0);"
                                                                onclick="open_conf('vnt_route');">路由转发信息</a>&nbsp;
                                                            <a type="button" class="info_btn" style="cursor:pointer"
                                                                href="javascript:void(0);"
                                                    ...
                                                    <tr>
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(3)">虚拟网络名称 (network_code)</a></th>
                                                        <td>
                                                            <input type="password" name="vnt_token" id="vnt_token"
                                                                title="要加入的虚拟网络名称，必须与服务端已建立的网络名一致。&#10;加入默认网络: 填 default&#10;加入自定义网络(custom_nets): 填对应的网络名，如 net1"
                                                    ...
                                                    <tr>
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(6)">接口模式</a></th>
                                                        <td>
                                                            <select id="vnt_ipmode" name="vnt_ipmode"
                                                                style="width:165px;margin:0px 0px 0px 2px;" value="dhcp"
                                                                class="input_option">
                                                    ...
                                                    <tr id="static_ip" style="display: none;">
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(7)">指定虚拟 IP (ip)</a></th>
                                                        <td>
                                                            <input type="text" class="input_ss_table" value=""
                                                                id="vnt_static_ip" title="指定当前客户端虚拟IP，例如: 10.26.0.10"
                                                                name="vnt_static_ip"
                                                                placeholder="选择静态指定时必填，请输入有效的IP地址！" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(8)">硬件设备 ID (device_id)</a></th>
                                                        <td>
                                                            <input type="text" class="input_ss_table" value=""
                                                                id="vnt_desvice_id"
                                                                title="设备物理硬件ID，例如: f3e9f8f8-7aaa-411f-8790-0173c6e8cf58。注意：每台设备ID不能相同！"
                                                                name="vnt_desvice_id" placeholder="选填，建议和虚拟IP地址填写一致" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(9)">设备别名 (device_name)</a></th>
                                                        <td>
                                                            <input type="text" class="input_ss_table" value=""
                                                                id="vnt_desvice_name"
                                                                title="设备别名，用于标识此客户端，例如: Merlin_Router"
                                                                name="vnt_desvice_name"
                                                                placeholder="选填，设备别名，例如: Merlin_Router" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                        ...
                                                        <td>
                                                            <input type="password" name="vnt_key" id="vnt_key"
                                                                ...
                                                                onFocus="switchType(this, true);"
                                                                placeholder="必填: 对应服务端网络的秘钥（加入 default 则填 default_secret 的值）" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>
                                                            <label><a class="hintstyle" href="javascript:void(0);"
                                                                    onclick="openssHint(27)">开启优化传输 (rtx)</a></label>
                                                        </th>
                                                        <td colspan="2">
                                                            <div class="switch_field"
                                                                style="display:table-cell;float: left;">
                                                                <label for="vnt_first_latency_enable">
                                                                    <input id="vnt_first_latency_enable" class="switch"
                                                                        type="checkbox" style="display: none;">
                                                                    <div class="switch_container">
                                                                        <div class="switch_bar"></div>
                                                                        <div class="switch_circle transition_style">
                                                    ...
                                                    <tr>
                                                        <th>
                                                            <label><a class="hintstyle" href="javascript:void(0);"
                                                                    onclick="openssHint(42)">开启 LZ4 数据压缩
                                                                    (compress)</a></label>
                                                        </th>
                                                        <td colspan="2">
                                                            <div class="switch_field"
                                                                ...
                                                                <label for="vnt_compressor">
                                                                    <input id="vnt_compressor" class="switch"
                                                                        type="checkbox" style="display: none;">
                                                                    <div class="switch_container">
                                                                        <div class="switch_bar"></div>
                                                                        <div class="switch_circle transition_style">
                                                    ...
                                                    <tr>
                                                        <th>
                                                            <label><a class="hintstyle" href="javascript:void(0);"
                                                                    onclick="openssHint(12)">开启前向纠错 (fec)</a></label>
                                                        </th>
                                                        <td colspan="2">
                                                            <div class="switch_field"
                                                                style="display:table-cell;float: left;">
                                                                <label for="vnt_fec">
                                                                    <input id="vnt_fec" class="switch" type="checkbox"
                                                                        style="display: none;">
                                                                    <div class="switch_container">
                                                                        <div class="switch_bar"></div>
                                                                        <div class="switch_circle transition_style">
                                                    ...
                                                    <tr>
                                                        <th>
                                                            <label><a class="hintstyle" href="javascript:void(0);"
                                                                    onclick="openssHint(45)">允许本节点作为映射出口
                                                                    (allow_mapping)</a></label>
                                                        </th>
                                                        <td colspan="2">
                                                            <div class="switch_field"
                                                                style="display:table-cell;float: left;">
                                                                <label for="vnt_allow_mapping">
                                                                    <input id="vnt_allow_mapping" class="switch"
                                                                        type="checkbox" style="display: none;">
                                                                    <div class="switch_container">
                                                                        <div class="switch_bar"></div>
                                                                        <div class="switch_circle transition_style">
                                                    ...
                                                    <tr>
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(28)">虚拟网卡名称 (tun_name)</a></th>
                                                        <td>
                                                            <input type="text" class="input_ss_table" value=""
                                                                id="vnt_tun_name" title="虚拟网卡名称，默认: vnt-tun"
                                                                name="vnt_tun_name" placeholder="默认: vnt-tun" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>
                                                            <label><a class="hintstyle" href="javascript:void(0);"
                                                                    onclick="openssHint(43)">禁用虚拟网卡 (no_tun)</a></label>
                                                        </th>
                                                        <td colspan="2">
                                                            <div class="switch_field"
                                                                style="display:table-cell;float: left;">
                                                                <label for="vnt_no_tun">
                                                                    <input id="vnt_no_tun" class="switch"
                                                                        type="checkbox" style="display: none;">
                                                                    <div class="switch_container">
                                                                        <div class="switch_bar"></div>
                                                                        <div class="switch_circle transition_style">
                                                    ...
                                                    <tr>
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(44)">隧道通信端口 (tunnel_port)</a></th>
                                                        <td>
                                                            <input type="text"
                                                                oninput="this.value=this.value.replace(/[^\d]/g, '')"
                                                                class="input_ss_table" id="vnt_tunnel_port"
                                                                title="隧道端口，用于P2P通信 (默认为0，自动分配)" name="vnt_tunnel_port"
                                                                placeholder="默认为0 (自动分配)" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(16)">最大传输单元 (MTU)</a></th>
                                                        <td>
                                                            <input type="text"
                                                                oninput="this.value=this.value.replace(/[^\d]/g, '')"
                                                                class="input_ss_table" id="vnt_mtu"
                                                                title="最大传输单元（MTU）。留空使用自动默认值" name="vnt_mtu"
                                                                placeholder="默认自动" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(25)">证书安全校验 (cert_mode)</a></th>
                                                        <td>
                                                            <input type="text" class="input_ss_table" id="vnt_cert_mode"
                                                                title="留空则跳过验证(skip)，或输入standard，或输入finger:指纹"
                                                                name="vnt_cert_mode"
                                                                placeholder="留空跳过验证，或输入 finger:xxxx..." />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>
                                                            <label><a class="hintstyle" href="javascript:void(0);"
                                                                    onclick="openssHint(22)">开启 IP 转发
                                                                    (no_nat)</a></label>
                                                        </th>
                                                        <td colspan="2">
                                                            <div class="switch_field"
                                                                ...
                                                                <label for="vnt_proxy_enable">
                                                                    <input id="vnt_proxy_enable" class="switch"
                                                                        type="checkbox" style="display: none;">
                                                                    <div class="switch_container">
                                                                        <div class="switch_bar"></div>
                                                                        <div class="switch_circle transition_style">
                                                    ...
                                                    <tr>
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(26)">连接模式 (no_punch)</a></th>
                                                        <td>
                                                            <select id="vnt_relay_enable" name="vnt_relay_enable"
                                                                style="width:165px;margin:0px 0px 0px 2px;"
                                                                class="input_option">
                                                    ...
                                                    <tr>
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(41)">本地端口映射 (port_mapping)</a></th>
                                                        <td>
                                                            <textarea type="text" class="input_ss_table"
                                                                id="vnt_mapping"
                                                                title="本地端口映射，例如: tcp:0.0.0.0:80->10.26.0.10:80。一行输入一条，以换行或逗号分隔"
                                                                name="vnt_mapping"
                                                                placeholder="选填，格式例如: tcp:0.0.0.0:80->10.26.0.10:80。一行输入一条，以换行或逗号分隔"
                                                                style="height: 50px; font-family:'Courier New', Courier, mono; font-size: 11px;"></textarea>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(10)">本地子网对外宣告 (output)</a></th>
                                                        <td>
                                                            <textarea type="text" class="input_ss_table"
                                                                id="vnt_localadd"
                                                                title="宣告本地局域网段，例如: 192.168.50.0/24。多个网段以逗号或换行分隔"
                                                                name="vnt_localadd"
                                                                placeholder="选填，宣告本地局域网段，例如: 192.168.50.0/24。多个网段以英文逗号 ','、'|' 或换行分隔"
                                                                style="height: 50px; font-family:'Courier New', Courier, mono; font-size: 11px;"></textarea>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(11)">目标局域网路由转发 (input)</a></th>
                                                        <td>
                                                            <textarea type="text" class="input_ss_table"
                                                                id="vnt_peeradd"
                                                                title="目标局域网路由转发，例如: 192.168.60.0/24,10.26.0.2。多个以逗号或换行分隔"
                                                                name="vnt_peeradd"
                                                                placeholder="选填，添加到对端局域网的路由，例如: 192.168.123.0/24。多个网段以英文逗号 ','、'|' 或换行分隔"
                                                                style="height: 50px; font-family:'Courier New', Courier, mono; font-size: 11px;"></textarea>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <table width="100%" border="1" align="center" cellpadding="4"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <td colspan="2"><a class="hintstyle"
                                                                    href="javascript:void(0);"
                                                                    onclick="openssHint(23)">vnts 服务器设置</a></td>
                                                        </tr>
                                                    </thead>
                                                    <tr id="vnts">
                                                        <th>
                                                            <label><a class="hintstyle" href="javascript:void(0);"
                                                                    onclick="openssHint(29)">开启服务器</a></label>
                                                        </th>
                                                        <td colspan="2">
                                                            <div class="switch_field"
                                                                style="display:table-cell;float: left;">
                                                                <label for="vnts_enable">
                                                                    <input id="vnts_enable" class="switch"
                                                                        type="checkbox" style="display: none;">
                                                                    <div class="switch_container">
                                                                        <div class="switch_bar"></div>
                                                                        <div class="switch_circle transition_style">
                                                            ...
                                                            <a> <button id="vnts_action_btn"
                                                                    class="vnt_custom_btn"></button></a>
                                                            <a type="button" class="web_btn"
                                                                style="cursor:pointer; display: none;padding-top:2px;margin-left:6px;margin-top:0px;float: right; position: relative; right: 60%;"
                                                                href="javascript:void(0);"
                                                                onclick="openWebInterface()">WEB界面</a>
                                                        </td>
                                                    </tr>
                                                    <tr id="vnts_status">
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            每 <input type="text"
                                                                oninput="this.value=this.value.replace(/[^\d]/g, '')"
                                                                id="vnts_cron_time" name="vnts_cron_time"
                                                                class="input_3_table" maxlength="2" value="0"
                                                                placeholder="" />
                                                            <select id="vnts_cron_hour_min" name="vnts_cron_hour_min"
                                                                style="width:60px;margin:3px 2px 0px 2px;"
                                                                class="input_option">
                                                                <option value="min">分钟</option>
                                                                <option value="hour">小时</option>
                                                            </select>
                                                            <select id="vnts_cron_type" name="vnts_cron_type"
                                                                style="width:60px;margin:3px 2px 0px 2px;"
                                                                class="input_option">
                                                                <option value="watch">检查</option>
                                                                <option value="start">重启</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a type="button" class="info_btn" style="cursor:pointer"
                                                                href="javascript:void(0);"
                                                                onclick="open_conf('vnts_cmd');">状态信息</a>&nbsp;
                                                            <a type="button" class="info_btn" style="cursor:pointer"
                                                                href="javascript:void(0);"
                                                    ...
                                                    <tr>
                                                        <th width="20%"><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(50)">连接验证密码 (server_token)</a></th>
                                                        <td>
                                                            <input type="text" class="input_ss_table" id="vnts2_token"
                                                                title="全局接入口令，所有客户端接入服务端时必须提供此密码。&#10;对应客户端的「服务端验证密码(server_token)」字段。&#10;留空表示不开启全局验证"
                                                                name="vnts2_token"
                                                                placeholder="选填，全局接入口令（对应客户端的「服务端验证密码」字段）" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(33)">默认网络分配网段 (network)</a></th>
                                                        <td colspan="2">
                                                            <input type="text" class="input_ss_table" id="vnts2_network"
                                                                title="服务端默认网络「default」的虚拟 IP 分配网段。&#10;客户端 Token 填 default 时，从此网段分配 IP。"
                                                                name="vnts2_network" placeholder="默认: 10.26.0.0/24" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <th><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(52)">IP 租约失效时长 (秒)</a></th>
                                                        <td colspan="2">
                                                            <input type="text" class="input_ss_table"
                                                                id="vnts2_lease_duration"
                                                                title="IP 租约回收失效时长（秒），默认: 86400 (24小时)"
                                                                name="vnts2_lease_duration"
                                                                placeholder="默认: 86400 (24小时)" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(53)">本地数据持久化保存 (persistence)</a>
                                                        </th>
                                                        <td colspan="2">
                                                            <div class="switch_field"
                                                                style="display:table-cell;float:left;margin-top:0px;">
                                                                <label for="vnts2_persistence">
                                                                    <input id="vnts2_persistence" class="switch"
                                                                        type="checkbox" style="display: none;">
                                                                    <div class="switch_container">
                                                                        <div class="switch_bar"></div>
                                                                        <div class="switch_circle transition_style">
                                                    ...
                                                    <tr>
                                                        <th><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(61)">自定义附加网络 (custom_nets)</a></th>
                                                        <td colspan="2">
                                                            <textarea type="text" class="input_ss_table"
                                                                id="vnts2_custom_nets"
                                                                title="在默认网络(default)之外额外创建的虚拟网络，每个网络具有独立的虚拟网段和秘钥。&#10;格式: 网络名=虚拟网段&#10;示例: net1=10.26.1.0/24&#10;客户端 Token 填 net1 即可加入此网络"
                                                                name="vnts2_custom_nets"
                                                                placeholder="选填，格式: 网络名=虚拟网段 例: net1=10.26.1.0/24  |  net2=10.26.2.0/24"
                                                                style="height: 50px; font-family:'Courier New', Courier, mono; font-size: 11px;"></textarea>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <th><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(54)">TCP 服务监听绑定 (tcp_bind)</a></th>
                                                        <td colspan="2">
                                                            <input type="text" class="input_ss_table"
                                                                id="vnts2_tcp_bind"
                                                                title="自建服务端 TCP 监听绑定，默认: 0.0.0.0:29872"
                                                                name="vnts2_tcp_bind" placeholder="默认: 0.0.0.0:29872" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(55)">QUIC 服务监听绑定 (quic_bind)</a>
                                                        </th>
                                                        <td colspan="2">
                                                            <input type="text" class="input_ss_table"
                                                                id="vnts2_quic_bind"
                                                                title="自建服务端 QUIC 监听绑定，默认: 0.0.0.0:29872"
                                                                name="vnts2_quic_bind"
                                                                placeholder="默认: 0.0.0.0:29872" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(56)">WS/WSS 服务监听绑定 (ws_bind)</a>
                                                        </th>
                                                        <td colspan="2">
                                                            <input type="text" class="input_ss_table" id="vnts2_ws_bind"
                                                                title="自建服务端 WS/WSS 监听绑定，默认: 0.0.0.0:29872"
                                                                name="vnts2_ws_bind" placeholder="默认: 0.0.0.0:29872" />
                                                        </td>
                                                    </tr>
                                                    <tr style="background-color: #576d73; color: #fff;">
                                                        <td colspan="3" style="font-weight: bold; padding: 6px 10px;">
                                                    ...
                                                    <tr>
                                                        <th><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(37)">Web 监听绑定 (web_bind)</a></th>
                                                        <td colspan="2">
                                                            <input type="text" class="input_ss_table"
                                                                id="vnts2_web_bind"
                                                                title="自建服务端 Web 监听端口，默认: 0.0.0.0:29871"
                                                                name="vnts2_web_bind" placeholder="默认: 0.0.0.0:29871" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(38)">Web 登录用户名</a></th>
                                                        <td colspan="2">
                                                            <input type="text" class="input_ss_table"
                                                                id="vnts2_username" title="自建服务端 Web 登录用户名，默认: admin"
                                                                name="vnts2_username" placeholder="默认: admin" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(39)">Web 登录密码</a></th>
                                                        <td colspan="2">
                                                            <input type="password" class="input_ss_table"
                                                                id="vnts2_password" title="自建服务端 Web 登录密码，默认: admin"
                                                                name="vnts2_password" placeholder="默认: admin"
                                                                onBlur="switchType(this, false);"
                                                                onFocus="switchType(this, true);"
                                                    ...
                                                    <tr>
                                                        <th><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(57)">TLS 公钥证书文件路径 (cert)</a></th>
                                                        <td colspan="2">
                                                            <input type="text" class="input_ss_table" id="vnts2_cert"
                                                                title="例如: /koolshare/vnt2/cert.pem" name="vnts2_cert"
                                                                placeholder="例如: /koolshare/vnt2/cert.pem" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(58)">TLS 私钥密钥文件路径 (key)</a></th>
                                                        <td colspan="2">
                                                            <input type="text" class="input_ss_table" id="vnts2_key"
                                                                title="例如: /koolshare/vnt2/key.pem" name="vnts2_key"
                                                    ...
                                                    <tr>
                                                        <th><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(59)">互联监听绑定 (server_quic_bind)</a>
                                                        </th>
                                                        <td colspan="2">
                                                            <input type="text" class="input_ss_table"
                                                                id="vnts2_server_quic_bind"
                                                                title="多服务器级联互联监听，例如: 0.0.0.0:29873"
                                                                name="vnts2_server_quic_bind"
                                                                placeholder="例如: 0.0.0.0:29873" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th><a class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(60)">互联服务器节点列表 (peer_servers)</a>
                                                        </th>
                                                        <td colspan="2">
                                                            <textarea type="text" class="input_ss_table"
                                                                id="vnts2_peer_servers"
                                                                title="多服务器级联互联地址列表，例如: 1.2.3.4:29873"
                                                                name="vnts2_peer_servers"
                                                                placeholder="例如: 1.2.3.4:29873。多个地址以英文逗号 ','、'|' 或换行分隔"
                                                                style="height: 50px; font-family:'Courier New', Courier, mono; font-size: 11px;"></textarea>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <div id="conf_table">
                                                <table width="100%" border="1" align="center" cellpadding="4"
                                                    cellspacing="0" bordercolor="#6b8fa3" class="FormTable_table"
                                                    style="box-shadow: 3px 3px 10px #000;margin-top: 0px;">
                                                    <thead>
                                                        <tr>
                                                            <td colspan="2"><a class="hintstyle"
                                                                    href="javascript:void(0);"
                                                                    onclick="openssHint(35)">上传程序</a></td>
                                                        </tr>
                                                    </thead>
                                                    <tr>
                                                        <th><a sclang class="hintstyle" href="javascript:void(0);"
                                                                onclick="openssHint(35)">选择文件</a></th>
                                                        <td>
                                                            ...
                                                            <span sclang id="file_info"
                                                                style="display:none;">上传完成</span>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <div id="log_content" class="soft_setting_log">
                                                    <textarea cols="63" rows="40" wrap="on" readonly="readonly"
                                                        id="soft_log_area" class="soft_setting_log1" autocomplete="off"
                                                        autocorrect="off" autocapitalize="off"
                                                        spellcheck="false"></textarea>
                                                </div>
                                            </div>
                                            <div class="apply_gen">
                                                <span><input class="button_gen" id="cmdBtn" onclick="save()"
                                            ...
                                            <div id="vnts_log" class="contentM_qis"
                                                style="box-shadow: 3px 3px 10px #000;margin-top: 70px;">
                                                <div class="user_title">VNTS 日志文件 / 标准输出&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                        href="javascript:void(0)" onclick="close_conf('vnts_log');"
                                                        value="关闭"><span class="close"></span></a></div>
                                                <div id="user_tr"
                                                    style="margin: 10px 10px 10px 10px;width:98%;text-align:center;">
                                                    <textarea cols="50" rows="20" wrap="off" id="vnts_logtxt"
                                                ...
                                                <div
                                                    ...
                                                    <input id="edit_node1" class="button_gen" type="button"
                                                        onclick="close_conf('vnts_log');" value="返回主界面">
                                                    &nbsp;&nbsp;<input class="button_gen" type="button"
                                                        onclick="close_conf('vnts_log');clear_vntslog();" value="清空日志">
                                                </div>
                                            </div>
                                            ...
                                            <div id="vnts_cmd" class="contentM_qis"
                                                ...
                                                <div class="user_title">VNTS 状态参数 / 标准输出&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                        href="javascript:void(0)" onclick="close_conf('vnts_cmd');"
                                                        value="关闭"><span class="close"></span></a></div>
                                                <div id="user_tr"
                                                    style="margin: 10px 10px 10px 10px;width:98%;text-align:center;">
                                                    <textarea cols="50" rows="20" wrap="off" id="vnts_cmdtxt"
                                                        style="width:97%;padding-left:10px;padding-right:10px;border:1px solid #222;font-family:'Courier New', Courier, mono; font-size:11px;background:#475A5F;color:#FFFFFF;outline: none;"
                                                        autocomplete="off" autocorrect="off" autocapitalize="off"
                                                        spellcheck="false"></textarea>
                                                </div>
                                                <div
                                                    ...
                                                    <input id="edit_node2" class="button_gen" type="button"
                                                        onclick="close_conf('vnts_cmd');" value="返回主界面">
                                                </div>
                                            </div>

                                            <div id="vnts_fingerprint" class="contentM_qis"
                                                style="box-shadow: 3px 3px 10px #000;margin-top: 70px;">
                                                <div class="user_title">VNTS Fingerprint 指纹&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                        href="javascript:void(0)"
                                                        onclick="close_conf('vnts_fingerprint');" value="关闭"><span
                                                            class="close"></span></a></div>
                                                <div id="user_tr"
                                                    style="margin: 10px 10px 10px 10px;width:98%;text-align:center;">
                                                    <textarea cols="50" rows="20" wrap="off" id="vnts_fingerprinttxt"
                                                        style="width:97%;padding-left:10px;padding-right:10px;border:1px solid #222;font-family:'Courier New', Courier, mono; font-size:11px;background:#475A5F;color:#FFFFFF;outline: none;"
                                                        autocomplete="off" autocorrect="off" autocapitalize="off"
                                                        spellcheck="false"></textarea>
                                                </div>
                                            ...
                                            <div id="vnt_log" class="contentM_qis"
                                                style="box-shadow: 3px 3px 10px #000;margin-top: 70px;">
                                                <div class="user_title">VNT 日志文件 / 标准输出&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                        href="javascript:void(0)" onclick="close_conf('vnt_log');"
                                                        value="关闭"><span class="close"></span></a></div>
                                                <div id="user_tr"
                                                    style="margin: 10px 10px 10px 10px;width:98%;text-align:center;">
                                                    <textarea cols="50" rows="20" wrap="off" id="vnt_logtxt"
                                                        style="width:97%;padding-left:10px;padding-right:10px;border:1px solid #222;font-family:'Courier New', Courier, mono; font-size:11px;background:#475A5F;color:#FFFFFF;outline: none;"
                                                        autocomplete="off" autocorrect="off" autocapitalize="off"
                                                        spellcheck="false"></textarea>
                                                </div>
                                                <div
                                                    style="margin-top:5px;padding-bottom:10px;width:100%;text-align:center;">
                                                    <input id="edit_node3" class="button_gen" type="button"
                                            ...
                                            <div id="vnt_info" class="contentM_qis"
                                                style="box-shadow: 3px 3px 10px #000;margin-top: 70px;">
                                                <div class="user_title">VNT 本机设备信息 / 标准输出&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                        href="javascript:void(0)" onclick="close_conf('vnt_info');"
                                                        value="关闭"><span class="close"></span></a></div>
                                                <div id="user_tr"
                                                    style="margin: 10px 10px 10px 10px;width:98%;text-align:center;">
                                                    <textarea cols="50" rows="20" wrap="off" id="vnt_infotxt"
                                                        style="width:97%;padding-left:10px;padding-right:10px;border:1px solid #222;font-family:'Courier New', Courier, mono; font-size:11px;background:#475A5F;color:#FFFFFF;outline: none;"
                                                        autocomplete="off" autocorrect="off" autocapitalize="off"
                                                        spellcheck="false"></textarea>
                                                </div>
                                                <div
                                                    style="margin-top:5px;padding-bottom:10px;width:100%;text-align:center;">
                                                    <input id="edit_node4" class="button_gen" type="button"
                                                        onclick="close_conf('vnt_info');" value="返回主界面">
                                                </div>
                                            </div>

                                            <div id="vnt_all" class="contentM_qis"
                                                style="box-shadow: 3px 3px 10px #000;margin-top: 70px;">
                                                <div class="user_title">VNT 所有设备信息/ 标准输出&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                        href="javascript:void(0)" onclick="close_conf('vnt_all');"
                                                        value="关闭"><span class="close"></span></a></div>
                                                <div id="user_tr"
                                                    style="margin: 10px 10px 10px 10px;width:98%;text-align:center;">
                                                    <textarea cols="50" rows="20" wrap="off" id="vnt_alltxt"
                                                        style="width:97%;padding-left:10px;padding-right:10px;border:1px solid #222;font-family:'Courier New', Courier, mono; font-size:11px;background:#475A5F;color:#FFFFFF;outline: none;"
                                                        autocomplete="off" autocorrect="off" autocapitalize="off"
                                                        spellcheck="false"></textarea>
                                                </div>
                                                <div
                                                    style="margin-top:5px;padding-bottom:10px;width:100%;text-align:center;">
                                                    <input id="edit_node5" class="button_gen" type="button"
                                                        onclick="close_conf('vnt_all');" value="返回主界面">
                                                </div>
                                            </div>

                                            <div id="vnt_list" class="contentM_qis"
                                                style="box-shadow: 3px 3px 10px #000;margin-top: 70px;">
                                                <div class="user_title">VNT 所有设备列表 / 标准输出&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                        href="javascript:void(0)" onclick="close_conf('vnt_list');"
                                                        value="关闭"><span class="close"></span></a></div>
                                                <div id="user_tr"
                                                    style="margin: 10px 10px 10px 10px;width:98%;text-align:center;">
                                                    <textarea cols="50" rows="20" wrap="off" id="vnt_listtxt"
                                                        style="width:97%;padding-left:10px;padding-right:10px;border:1px solid #222;font-family:'Courier New', Courier, mono; font-size:11px;background:#475A5F;color:#FFFFFF;outline: none;"
                                                        autocomplete="off" autocorrect="off" autocapitalize="off"
                                                        spellcheck="false"></textarea>
                                                </div>
                                                <div
                                                    style="margin-top:5px;padding-bottom:10px;width:100%;text-align:center;">
                                                    <input id="edit_node6" class="button_gen" type="button"
                                                        onclick="close_conf('vnt_list');" value="返回主界面">
                                                </div>
                                            </div>

                                            <div id="vnt_route" class="contentM_qis"
                                                style="box-shadow: 3px 3px 10px #000;margin-top: 70px;">
                                                <div class="user_title">VNT 路由转发信息 / 标准输出&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                        href="javascript:void(0)" onclick="close_conf('vnt_route');"
                                                        value="关闭"><span class="close"></span></a></div>
                                                <div id="user_tr"
                                                    style="margin: 10px 10px 10px 10px;width:98%;text-align:center;">
                                                    <textarea cols="50" rows="20" wrap="off" id="vnt_routetxt"
                                                        style="width:97%;padding-left:10px;padding-right:10px;border:1px solid #222;font-family:'Courier New', Courier, mono; font-size:11px;background:#475A5F;color:#FFFFFF;outline: none;"
                                                        autocomplete="off" autocorrect="off" autocapitalize="off"
                                                        spellcheck="false"></textarea>
                                                </div>
                                                <div
                                                    style="margin-top:5px;padding-bottom:10px;width:100%;text-align:center;">
                                                    <input id="edit_node7" class="button_gen" type="button"
                                                        onclick="close_conf('vnt_route');" value="返回主界面">
                                                </div>
                                            </div>

                                            <div id="vnt_cmd" class="contentM_qis"
                                                style="box-shadow: 3px 3px 10px #000;margin-top: 70px;">
                                                <div class="user_title">VNT 状态参数 / 标准输出&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                        href="javascript:void(0)" onclick="close_conf('vnt_cmd');"
                                                        value="关闭"><span class="close"></span></a></div>
                                                <div id="user_tr"
                                                    style="margin: 10px 10px 10px 10px;width:98%;text-align:center;">
                                                    <textarea cols="50" rows="20" wrap="off" id="vnt_cmdtxt"
                                                        style="width:97%;padding-left:10px;padding-right:10px;border:1px solid #222;font-family:'Courier New', Courier, mono; font-size:11px;background:#475A5F;color:#FFFFFF;outline: none;"
                                                        autocomplete="off" autocorrect="off" autocapitalize="off"
                                                        spellcheck="false"></textarea>
                                                </div>
                                                <div
                                                    style="margin-top:5px;padding-bottom:10px;width:100%;text-align:center;">
                                                    <input id="edit_node8" class="button_gen" type="button"
                                                        onclick="close_conf('vnt_cmd');" value="返回主界面">
                                                </div>
                                            </div>
