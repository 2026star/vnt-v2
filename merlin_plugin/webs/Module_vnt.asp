        ...
        <td valign="top">
            ...
            <button id="vnt_action_btn" class="vnt_custom_btn"></button>
										...
										<tr>
                                            ...
                                            <td>
                                                <input type="password" name="vnt_token" id="vnt_token" class="input_ss_table" autocomplete="new-password" autocorrect="off" autocapitalize="off" maxlength="64" value="" onBlur="switchType(this, false);" onFocus="switchType(this, true);" placeholder="必填，虚拟网络 Token" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <th width="20%"><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(1)">服务器地址 (server)</a></th>
                                            <td>
                                                <textarea type="text" class="input_ss_table" value="" id="vnt_serveraddr" name="vnt_serveraddr" placeholder="例如: tcp://vnt.wherewego.top:29872。多个地址以英文逗号 ','、'|' 或换行分隔" style="height: 50px; font-family:'Courier New', Courier, mono; font-size: 11px;"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr id="static_ip" style="display: none;">
                                            ...
                                            <td>
                                                <input type="text" class="input_ss_table" value="" id="vnt_static_ip" name="vnt_static_ip" placeholder="选择静态指定时必填，请输入有效的IP地址！"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th width="20%"><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(8)">硬件设备 ID (device_id)</a></th>
                                            <td>
                                                <input type="text" class="input_ss_table" value="" id="vnt_desvice_id" name="vnt_desvice_id" placeholder="选填，建议和虚拟IP地址填写一致" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <th width="20%"><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(9)">设备别名 (device_name)</a></th>
                                            <td>
                                                <input type="text" class="input_ss_table" value="" id="vnt_desvice_name" name="vnt_desvice_name" placeholder="选填，设备别名，例如: Merlin_Router" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <th width="20%"><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(20)">数据加密密码 (password)</a></th>
                                            <td>
                                                <input type="password" name="vnt_key" id="vnt_key" class="input_ss_table" autocomplete="new-password" autocorrect="off" autocapitalize="off" value="" onBlur="switchType(this, false);" onFocus="switchType(this, true);" placeholder="选填，端到端加密密码，留空则不开启加密" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="input_ss_table" value="" id="vnt_tun_name" name="vnt_tun_name" placeholder="默认: vnt-tun" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <th width="20%"><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(16)">最大传输单元 (MTU)</a></th>
                                            <td>
                                                <input type="text" oninput="this.value=this.value.replace(/[^\d]/g, '')" class="input_ss_table" id="vnt_mtu" name="vnt_mtu" placeholder="默认自动" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select id="vnt_relay_enable" name="vnt_relay_enable" style="width:165px;margin:0px 0px 0px 2px;" value="all" class="input_option">
                                                    <option value="all">自动打洞 (P2P)</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea type="text" class="input_ss_table" id="vnt_mapping" name="vnt_mapping" placeholder="选填，格式例如: tcp:0.0.0.0:80->10.26.0.10:80。一行输入一条，以换行或逗号分隔" style="height: 50px; font-family:'Courier New', Courier, mono; font-size: 11px;"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th width="20%"><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(10)">本地子网对外宣告 (output)</a></th>
                                            <td>
                                                <textarea type="text" class="input_ss_table" id="vnt_localadd" name="vnt_localadd" placeholder="选填，宣告本地局域网段，例如: 192.168.50.0/24。多个网段以英文逗号 ','、'|' 或换行分隔" style="height: 50px; font-family:'Courier New', Courier, mono; font-size: 11px;"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th width="20%"><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(11)">目标局域网路由转发 (input)</a></th>
                                            <td>
                                                <textarea type="text" class="input_ss_table" id="vnt_peeradd" name="vnt_peeradd" placeholder="选填，添加到对端局域网的路由，例如: 192.168.123.0/24。多个网段以英文逗号 ','、'|' 或换行分隔" style="height: 50px; font-family:'Courier New', Courier, mono; font-size: 11px;"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
